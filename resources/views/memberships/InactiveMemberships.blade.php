...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Socios con membresías inactivas</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
                    ...
                    <div id="dataTables-example_wrapper" class="dataTables_wrapper 
                        ...
                        <thead>
                            ...
                            <tr role="row">
                                ...
                                <!--th class="sorting" tabindex="0" aria-controls="dataTables-example" 
                                rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" 
                                style="width: 110px;">Código Postal
                                </th-->          
                                </th><th class="sorting" tabindex="0" aria-controls="dataTables-example" 
                                rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" 
                                style="width: 110px;">Teléfono Casa
                                </th>        
                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" 
                                rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" 
                                style="width: 110px;">Teléfono Movil
                                </th>         
                                <!--th class="sorting" tabindex="0" aria-controls="dataTables-example" 
                                rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" 
                        ...
                        <tbody>
                            ...
                            <tr class="gradeA odd" role="row">
                                ...
                                <td class="center">4441788404</td>
                                <!--td class="center">H</td!-->
                                <td class="center">01/Mar/1980</td>
                            </tr>    
                            @endfor
                        </tbody>
                    </table></div>
