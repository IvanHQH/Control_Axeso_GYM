                    ...
                    <div id="dataTables-example_wrapper" class="dataTables_wrapper 
                        ...
                        <thead>
                            ...
                            <tr role="row">
                                ...
                                style="width: 110px;">Foma de pago
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" 
                                rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" 
                        ...
                        <tr class="gradeA odd" role="row">
                            <td class="sorting_1">José Sanchéz Pérez</td>
                            <td>Membresía</td>
                            <td class="center">Mensualidad General</td>
                            <td>$700</td>
                            <td>TARJETA</td>
                            <td>25/07/2015 16:15</td>
                            <td class="center">Usuario 2</td>
                            <td style="text-align: center; vertical-align: middle; ">
                                <a id="edit_membership_paymet" class="edit ml10" href="javascript:void(0)" title="Editar">
                                    <i class="glyphicon glyphicon-edit">                                    
                                    </i>
                                </a>
                                <a id="delete_membership_paymet" class="remove ml10" href="javascript:void(0)" title="Eliminar">
